...
class PynotebookError(Exception):
...
class PynotebookFormError(Exception):
...
class Service(object):
    ...
    def _isinstance(self, model, raise_error=True):
        """Check if the specified model instance matches the service's model.
    ...
    def save(self, model):
        """Commits the model to the database and return the model
    ...
    def get(self, id):
        ...
        Returns `None` if an instance with the specified id does not exitst.
    ...
    def get_or_404(self, id):
        ...
        raise an 404 error if an instance with the specified id does not exist.
